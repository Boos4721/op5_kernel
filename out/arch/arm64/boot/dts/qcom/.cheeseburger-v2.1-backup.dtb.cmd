cmd_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; clang -E -Wp,-MD,arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-backup.dtb.d

source_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb := ../arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dts

deps_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb := \
  ...
  ../arch/arm64/boot/dts/qcom/cheeseburger-backup.dtsi \
...
arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb: $(deps_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-backup.dtb)
